...
trait DbFile {
  ...
  /**
    ...
    */
  def addTuple(tid: TransactionId, t: Tuple): Vector[Page]
  ...
  /**
    ...
    * can be used to look up the table via [[Catalog.getDbFile]] and
    * [[Catalog.getTupleDesc]].
    * <p>
